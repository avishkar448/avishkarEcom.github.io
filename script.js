    ...
    document.querySelector(".btn").addEventListener("click",()=>{
        ...
        let uname=document.getElementById("nm").value;
                if(uname.length==0){
                    ...
                    document.getElementById("txtnm").innerHTML="Usename should not be empty"
                }
        
        let pass=document.getElementById("pass").value;
        if(pass.length==0){ 
            document.getElementById("txtpass").style.color="red";
                    document.getElementById("txtpass").innerHTML="Password should not be empty"
        }
...
function register(){ 
    document.querySelector(".btn").addEventListener("click",()=>{
        ...
        if(fname.length==0){
            ...
            document.getElementById("txtfnm").innerHTML="Fill the fullname"
        }
        ...
        if(email1.length==0){
            ...
            document.getElementById("emtxt").innerHTML="email should not be empty"
        }
        ...
        if(phone.length==0){
            ...
            document.getElementById("phtxt").innerHTML="Phone number should not be empty"
        }
        ...
        if(p.length==0){
            txt+="Paasword Should not be empty"
        }
